...
samples = sys.argv[1]
adata_atac_file = "/storage/singlecell/zz4/fetal_snakemake/results/MultiVelo_filtered_cells/adata_atac.h5ad"
nn_idx_file = (
    "/storage/singlecell/zz4/fetal_snakemake/results/multivelo_seurat_wnn/"
    + samples
    + "_nn_idx.txt"
)
nn_dist_file = (
