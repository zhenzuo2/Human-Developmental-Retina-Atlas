...
CHROMBPNET_MODEL="/storage/singlecell/zz4/fetal_bash/results/chrombpnet_trained_models/latePRPC/models/chrombpnet.h5"
CHROMBPNET_MODEL_NB="/storage/singlecell/zz4/fetal_bash/results/chrombpnet_trained_models/latePRPC/models/chrombpnet_nobias.h5"
