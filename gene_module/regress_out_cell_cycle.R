...
write(colnames(res), file = paste(output_results_path,"cell_cycle_normed_colnames.txt",sep=""))
write(rownames(res), file = paste(output_results_path,"cell_cycle_normed_rownames.txt",sep=""))
writeMM(res, file = paste(output_results_path, "cell_cycle_normed.txt",sep=""))
