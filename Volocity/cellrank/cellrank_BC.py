...
adata.write(
    "/storage/singlecell/zz4/fetal_snakemake/results/cellrank_result/BC_adata.h5ad",
)
sc.pp.highly_variable_genes(
...
terminal_states = (
    adata.obs["majorclass"].replace("NRPC", np.nan).replace("BC Precursor", np.nan)
)
...
temp.to_csv(
    "/storage/singlecell/zz4/fetal_snakemake/results/cellrank_result/BC_to_terminal_states.csv"
)

joblib.dump(
    g,
    "/storage/singlecell/zz4/fetal_snakemake/results/cellrank_result/BC_g.h5ad",
)
