...
adata = scv.read(
    "/storage/singlecell/zz4/fetal_bash/results/subclass_annotation/RGC_annotation_adult/RGC_major_sub_class.h5ad"
)
scv.pl.umap(adata, color="majorclass", legend_loc="right margin")
scv.pl.umap(adata, color="leiden")

adata = adata[adata.obs.leiden.isin(["25", "8", "30", "12"])]
scv.pl.umap(adata, color="majorclass", legend_loc="right margin")
