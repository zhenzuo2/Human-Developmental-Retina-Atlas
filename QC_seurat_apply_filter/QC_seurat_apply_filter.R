...
seurat_object <- subset(seurat_object, subset = nFeature_RNA > 1000 & nFeature_RNA < 3000 & percent.mt < 5)
...
saveRDS(seurat_object, paste(output_results_path, sample_id, "_nFeature_RNA_1000_3000_MT_5_fitered.rds", sep = ""))