...
adata = scv.read(
    "/storage/singlecell/zz4/fetal_bash/results/subclass_annotation/BC_annotation_adult/BC_major_sub_class.h5ad"
)
scv.pl.umap(adata, color="majorclass", legend_loc="right margin")
scv.pl.umap(adata, color="leiden")

adata = adata[
    ~adata.obs.leiden.isin(["1", "5", "33", "29", "14", "19", "6", "37", "13"])
]
