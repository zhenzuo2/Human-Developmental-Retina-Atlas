...
subtypes = scv.read("/storage/singlecell/zz4/fetal_snakemake/results/cell_annotation_results/umap/HC_subtype.h5ad")
...
adata.write(
    "/storage/singlecell/zz4/fetal_snakemake/results/cell_annotation_results/umap/HC_subtype_NRPC.h5ad"
)
adata.obs.to_csv("/storage/singlecell/zz4/fetal_snakemake/results/cell_annotation_results/umap/HC_subtype_NRPC_obs.csv")
