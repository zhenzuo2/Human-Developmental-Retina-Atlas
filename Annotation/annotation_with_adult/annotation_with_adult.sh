adata_query_file="/storage/singlecell/zz4/fetal_bash/results/merged_h5ad/merged_raw_filtered_umap_10000.h5ad"
cell_type="AC"
...
output_fig_path="/storage/singlecell/zz4/fetal_bash/figures/subclass_annotation/AC_annotation_adult/"
resolution="5";
...
output_fig_path="/storage/singlecell/zz4/fetal_bash/figures/subclass_annotation/BC_annotation_adult/"
...
output_fig_path="/storage/singlecell/zz4/fetal_bash/figures/subclass_annotation/RGC_annotation_adult/"
...
output_fig_path="/storage/singlecell/zz4/fetal_bash/figures/subclass_annotation/HC_annotation_adult/"
...
output_fig_path="/storage/singlecell/zz4/fetal_bash/figures/subclass_annotation/Cone_annotation_adult/"
...
output_fig_path="/storage/singlecell/zz4/fetal_bash/figures/subclass_annotation/Rod_annotation_adult/"
CUDA_VISIBLE_DEVICES=1;
resolution="1";
slurmtaco.sh --g01 -m 20G -t 1 -- python3 annotation_with_adult.py "$adata_query_file" "$cell_type" "$adata_ref_file" "$output_result_path" "$output_fig_path" "$resolution";
...
output_fig_path="/storage/singlecell/zz4/fetal_bash/figures/subclass_annotation/MG_annotation_adult/"
CUDA_VISIBLE_DEVICES=2;
resolution="1";
slurmtaco.sh --g01 -m 20G -t 1 -- python3 annotation_with_adult.py "$adata_query_file" "$cell_type" "$adata_ref_file" "$output_result_path" "$output_fig_path" "$resolution";
