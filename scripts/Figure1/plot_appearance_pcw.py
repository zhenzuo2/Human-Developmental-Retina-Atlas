...
group_stats = sample_df.groupby(["Region", "majorclass"]).agg({"Days": ["mean", "std"]})
group_stats = group_stats.reset_index()

group_stats.columns = ["Region", "majorclass", "mean", "std"]
group_stats.to_csv("/storage/chentemp/zz4/adult_dev_compare/figures/Figure1/plot_appearance_pcw.csv")
