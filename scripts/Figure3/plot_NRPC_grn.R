output_dir = "/storage/chentemp/zz4/adult_dev_compare/figures/Figure3/"
label = "NRPC"
...
seurat_object <- readRDS("/storage/chentemp/zz4/adult_dev_compare/results/pando_results/pando_NRPC.rds")
...
ggsave(filename = paste(output_dir, label, "_grn_plot_with_edge.tiff", sep = ""),
    plot = grn_plot, scale = 1, width = 18, height = 18)
...
p <- p + geom_point(aes(x = UMAP_1, y = UMAP_2, color = TIME),size = dat$SUM*10,
