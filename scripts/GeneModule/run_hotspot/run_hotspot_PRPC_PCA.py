...
local_correlations.to_csv(
    output_path + "PRPC_hs_local_correlations_PCA.csv"
)
module_scores.to_csv(
    output_path + "PRPC_hs_module_scores_PCA.csv"
)
joblib.dump(
    hs,
    output_path + "PRPC_hs.create_modules_PCA.pkl",
)
adata.write(output_path + "PRPC_hs.adata_PCA.h5ad"
)
