...
try:
    os.makedirs("/storage/chentemp/zz4/adult_dev_compare/results/merged_h5ad/")
except FileExistsError:
    # directory already exists
    pass

try:
    os.makedirs("/storage/chentemp/zz4/adult_dev_compare/results/cell_annotation_results/")
except FileExistsError:
    # directory already exists
    pass
...
adata_ref = adata_ref[adata_ref.obs.majorclass!="Astrocyte"]
adata_ref.obs["Time"] = "Adult"
adata_ref.obs["Days"] = -1
print(adata_ref)
sc.pp.highly_variable_genes(adata_ref, flavor="seurat_v3", n_top_genes=2000,subset = True)
print(adata_ref)
