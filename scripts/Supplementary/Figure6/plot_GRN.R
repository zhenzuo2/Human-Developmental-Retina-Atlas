output_dir = "/storage/chentemp/zz4/adult_dev_compare/Supplementary/Figure6/"
...
for (label in c("BC","Rod","Cone","HC","RGC")){
    seurat_object <- readRDS(paste("/storage/chentemp/zz4/adult_dev_compare/results/pando_results/pando_",label,".rds",sep=""))
