...
adata_result = sc.read(
    "/storage/chentemp/zz4/adult_dev_compare/results/adata_object_UMAP/Rod.h5ad"
)
...
plt.savefig(
    "/storage/chentemp/zz4/adult_dev_compare/Supplementary/Figure3/Rod_dev_dotplot.tiff",
    dpi=300,
    bbox_inches="tight",
    transparent=True,
)
...
fig.set_size_inches(6, 4)
plt.savefig(
    "/storage/chentemp/zz4/adult_dev_compare/Supplementary/Figure3/Rod_adult_dotplot.tiff",
    dpi=300,
    bbox_inches="tight",
    transparent=True,
)
