...
adata = sc.read(
    "/storage/chentemp/zz4/adult_dev_compare/data/adult_reference/RGC/local.h5ad"
)
adata.X = adata.raw.X
adata.var.index = adata.var.feature_name.values
adata.raw = None
adata_result = sc.read(
    "/storage/chentemp/zz4/adult_dev_compare/results/adata_object_UMAP/RGC.h5ad"
)
...
adult_cy = [
    'OFF_MGC', 'OFF_PGC', 'ON_MGC', 'ON_PGC', 'OPN4_RGC', 'RGC6', 'RGC7', 'RGC8'
]

dev_cy = [
    'OFF_MGC', 'OFF_PGC', 'ON_MGC', 'ON_PGC', 'RGC Precursor']
...
plt.savefig(
    "/storage/chentemp/zz4/adult_dev_compare/Supplementary/Figure3/RGC_dev_dotplot.tiff",
    dpi=300,
    bbox_inches="tight",
    transparent=True,
)
...
fig.set_size_inches(6, 4)
plt.savefig(
    "/storage/chentemp/zz4/adult_dev_compare/Supplementary/Figure3/RGC_adult_dotplot.tiff",
    dpi=300,
    bbox_inches="tight",
    transparent=True,
)
