...
adata = sc.read(
    "/storage/chentemp/zz4/adult_dev_compare/data/adult_reference/HC/local.h5ad"
)
adata.X = adata.raw.X
adata.var.index = adata.var.feature_name.values
adata.raw = None
adata_result = sc.read(
    "/storage/chentemp/zz4/adult_dev_compare/results/adata_object_UMAP/HC.h5ad"
)
...
plt.savefig(
    "/storage/chentemp/zz4/adult_dev_compare/Supplementary/Figure3/HC_dev_dotplot.tiff",
    dpi=300,
    bbox_inches="tight",
    transparent=True,
)
...
fig.set_size_inches(4, 4)
plt.savefig(
    "/storage/chentemp/zz4/adult_dev_compare/Supplementary/Figure3/HC_adult_dotplot.tiff",
    dpi=300,
    bbox_inches="tight",
    transparent=True,
)
