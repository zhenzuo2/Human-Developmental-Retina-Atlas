...
genes = pd.read_csv("/storage/chentemp/zz4/adult_dev_compare/figures/Figure2/mod_reordered.csv")['Unnamed: 0']
adata_rna = adata_rna[:,adata_rna.var.index.isin(list(genes.values))]
