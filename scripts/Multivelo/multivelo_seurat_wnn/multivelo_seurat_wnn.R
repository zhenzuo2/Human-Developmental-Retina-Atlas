...
input_file <- "/storage/chentemp/zz4/adult_dev_compare/results/pando_merged_seurat_object/pando_merged_seurat_object.rds"
meta_file <- args[1]
sample_name <- args[2]
output_path <- "/storage/chentemp/zz4/adult_dev_compare/results/multivelo_seurat_wnn/"
...
filtered_cells <- read.csv("/storage/chentemp/zz4/adult_dev_compare/results/MultiVelo_filtered_cells/filtered_cells.csv")
