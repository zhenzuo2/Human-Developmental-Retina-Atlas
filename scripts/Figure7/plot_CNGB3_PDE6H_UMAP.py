...
for gene in markers:
    ...
    plt.savefig(
        "/storage/chentemp/zz4/adult_dev_compare/figures/Figure7/RA_genes/"
        + gene
        + "_Macula.tiff",
        dpi=600,
        bbox_inches="tight",
    ...
    region_colors = {"Macula" : "#F8766D", "Peripheral": "#00BFC4"}
...
for gene in markers:
    ...
    output_path = (
        "/storage/chentemp/zz4/adult_dev_compare/figures/Figure7/" + gene + ".tiff"
    )
