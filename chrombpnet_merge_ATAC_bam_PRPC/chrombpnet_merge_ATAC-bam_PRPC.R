...
if (!file.exists("/storage/singlecell/zz4/fetal_bash/results/merged_bam/earlyPRPC_unsorted_ATAC.bam")) {
  cat("samtools merge -f /storage/singlecell/zz4/fetal_bash/results/merged_bam/earlyPRPC_unsorted_ATAC.bam ",
      paste(bams, collapse = " "))
  cat("\n")
}
if (!file.exists("/storage/singlecell/zz4/fetal_bash/results/merged_bam/earlyPRPC_unsorted_ATAC.sort.bam")) {
  cat("samtools sort -m 10G -@ 8 /storage/singlecell/zz4/fetal_bash/results/merged_bam/earlyPRPC_unsorted_ATAC.bam -o /storage/singlecell/zz4/fetal_bash/results/merged_bam/earlyPRPC_unsorted_ATAC.sort.bam")
  cat("\n")
}
...
bams <- list.files("/storage/singlecell/zz4/fetal_bash/results/chrombpnet_subsetbam/latePRPC",
                   recursive = F, pattern = "*.bam$", full.names = T)
if (!file.exists("/storage/singlecell/zz4/fetal_bash/results/merged_bam/latePRPC_unsorted_ATAC.bam")) {
  cat("samtools merge -f /storage/singlecell/zz4/fetal_bash/results/merged_bam/latePRPC_unsorted_ATAC.bam ",
      paste(bams, collapse = " "))
  cat("\n")
}
if (!file.exists("/storage/singlecell/zz4/fetal_bash/results/merged_bam/latePRPC_unsorted_ATAC.sort.bam")) {
  cat("samtools sort -m 10G -@ 8 /storage/singlecell/zz4/fetal_bash/results/merged_bam/latePRPC_unsorted_ATAC.bam -o /storage/singlecell/zz4/fetal_bash/results/merged_bam/latePRPC_unsorted_ATAC.sort.bam")
  cat("\n")
}
