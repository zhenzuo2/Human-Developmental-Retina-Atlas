...
meta_file = "/storage/singlecell/zz4/fetal_snakemake/results/cell_annotation_results/NRPC_AC.csv"
...
write.csv(meta, "/storage/singlecell/zz4/fetal_snakemake/results/pseudotime/AC_NRPC_SCENT.csv")
