...
plt.savefig(
    output_file_path + "PRPC_MG_mv.velocity_embedding_stream_Days.svg",
    bbox_inches="tight",
    backend="cairo",
    transparent=True,
)
...
fig.set_size_inches(10, 10)
plt.savefig(
    output_file_path + "PRPC_MG_mv.velocity_embedding_stream_latent_time.svg",
    bbox_inches="tight",
    backend="cairo",
    transparent=True,
)
...
fig.set_size_inches(10, 10)
plt.savefig(
    output_file_path + "PRPC_MG_mv.velocity_embedding_stream_majorclass.svg",
    bbox_inches="tight",
    backend="cairo",
    transparent=True,
)