...
adata_result = scv.read(
    "/storage/singlecell/zz4/fetal_snakemake/results/multivelo_recover_dynamics_results/BC.h5ad"
)
...
plt.savefig(
    "/storage/singlecell/zz4/fetal_snakemake/figures/figure2/BC_UMAP_subtype.svg",
    bbox_inches="tight",
)
...
plt.savefig(
    "/storage/singlecell/zz4/fetal_snakemake/figures/figure2/BC_mv.velocity_embedding_stream.majorclass.svg",
    dpi=600,
)
...
fig.set_size_inches(10, 10)
plt.savefig(
    "/storage/singlecell/zz4/fetal_snakemake/figures/figure2/BC_mv.velocity_embedding_stream.Days.svg",
    dpi=600,
)
...
fig.set_size_inches(10, 10)
plt.savefig(
    "/storage/singlecell/zz4/fetal_snakemake/figures/figure2/BC_mv.velocity_embedding_stream.latent_time.svg",
    dpi=600,
)
