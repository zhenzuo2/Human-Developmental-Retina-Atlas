...
plt.savefig(
    "/storage/singlecell/zz4/fetal_snakemake/figures/figure1/gene_score_heatmap_markers.svg",
    bbox_inches="tight",
    transparent=True,
    backend = "cairo"
)
...
plt.savefig(
    "/storage/singlecell/zz4/fetal_snakemake/figures/figure1/gene_expression_heatmap_markers.svg",
    bbox_inches="tight",
    transparent=True,
    backend = "cairo"
)