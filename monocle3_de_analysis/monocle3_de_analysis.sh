...
/storage/singlecell/zz4/fetal_bash/results/merged_h5ad_adult_annotated/merged_h5ad_adult_annotated_obs.csv
...
/storage/singlecell/zz4/fetal_bash/results/merged_monocle3_DE_analysis/
...
for i in "${!meta_file[@]}"
do
	slurmtaco.sh -p gpu -m 20G -t 1 -- /storage/chen/home/zz4/anaconda3/envs/r/bin/Rscript monocle3_de_analysis.R  $input_file ${meta_file[i]} ${output_dir[i]} Early;
	slurmtaco.sh -p gpu -m 20G -t 1 -- /storage/chen/home/zz4/anaconda3/envs/r/bin/Rscript monocle3_de_analysis.R  $input_file ${meta_file[i]} ${output_dir[i]} Late;
	slurmtaco.sh -p gpu -m 20G -t 1 -- /storage/chen/home/zz4/anaconda3/envs/r/bin/Rscript monocle3_de_analysis.R  $input_file ${meta_file[i]} ${output_dir[i]} All;
done
